...
class DeliveriesTest < ApplicationSystemTestCase
  ...
  test "should create delivery" do
    ...
    fill_in "Delivery price", with: @delivery.delivery_price
    fill_in "Delivery provider", with: @delivery.delivery_provider
    fill_in "Delivery type", with: @delivery.delivery_type
